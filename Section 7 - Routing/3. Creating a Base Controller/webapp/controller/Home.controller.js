...
], function(BaseController, Fragment, Sorter, Filter, FilterOperator, Context, MessageBox, models, formatter) {
  "use strict"

  return BaseController.extend('ui5.product.list.controller.Home', {
    formatter: formatter,
