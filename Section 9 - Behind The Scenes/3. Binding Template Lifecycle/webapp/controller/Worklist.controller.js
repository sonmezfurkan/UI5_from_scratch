sap.ui.define([
    ...
    return BaseController.extend("ui5.my.products.controller.Worklist", {
         ...
         */
        onInit : function () {
            console.log("Initializing worklist controller");
            ...
            this.getRouter().getRoute("worklist").attachPatternMatched(function() {
                console.log("Worklist view placed in root control");
            }, this);
        },

        onExit: function() {
            console.log("Destroying worklist view");
        },

        onAfterRendering: function() {
            console.log("Worklist view is rendered");
        },
