		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Products",
									"targetURL": "#ui5myproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5myproducts-display": {
								"semanticObject": "ui5myproducts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.my.products",
									"url": sap.ui.require.toUrl("ui5/my/products")
								}
							}
						}
					}
