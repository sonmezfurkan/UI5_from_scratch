		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Users",
									"targetURL": "#odatav4demotrippin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatav4demotrippin-display": {
								"semanticObject": "odatav4demotrippin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.v4.demo.trippin",
									"url": sap.ui.require.toUrl("odata/v4/demo/trippin")
								}
							}
						}
					}
